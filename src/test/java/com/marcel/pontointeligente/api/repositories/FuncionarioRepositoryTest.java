...
public class FuncionarioRepositoryTest {
	...
	private static final String EMAIL = "aguiar_marcel@hotmail.com";
	private static final String CPF = "03385220424";
	...
	public void testBuscarFuncionarioPorEmailECpfParaCpfInvalido() {
		Funcionario funcionario = this.funcionarioRepository.findByCpfOrEmail("11111111123", EMAIL);
		assertNotNull(funcionario);
	}
	
	private Funcionario obterDadosFuncioario(Empresa empresa) {
