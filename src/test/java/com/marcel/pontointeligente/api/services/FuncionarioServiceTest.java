...
public class FuncionarioServiceTest {
	...
	public void testBuscarEmpresaPorCpf() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorCpf("03385220424");
		assertTrue(funcionario.isPresent());
	}
	
	@Test
	public void testBuscarEmpresaPorEmail() {
		Optional<Funcionario> funcionario = this.funcionarioService.buscarPorEmail("aguiar_marcel@hotmail.com");
		assertTrue(funcionario.isPresent());
	}
