...
import com.marcel.pontointeligente.api.dtos.EmpresaDto;
...
public class EmpresaController {
	...
	public ResponseEntity<Response<EmpresaDto>> buscarPorCnpj(@PathVariable("cnpj") String cnpj) {
		...
		Optional<Empresa> obj = empresaService.buscarPorCnpj(cnpj);
		...
		response.setData(this.converterEmpresaDto(obj.get()));
