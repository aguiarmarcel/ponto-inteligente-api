...
public class LancamentoController {
	...
	public ResponseEntity<Response<Page<LancamentoDto>>> listarPorFuncionarioId(
		...
		log.info("Buscando lançamentos por ID de funcionário: {}, página: {}", funcionarioId, pag);
		Response<Page<LancamentoDto>> response = new Response<Page<LancamentoDto>>();
		
		PageRequest pageReq = new PageRequest(pag, this.qtdPorPagina, Direction.valueOf(dir), ord);
		Page<Lancamento> lancamentos = this.lancamentoService.buscaPorFuncionarioId(funcionarioId, pageReq);
	...
	/**
	 * Converte um lancamentoDto em uma entidade lancamento.
	 * 
	 * @param lancamentoDto
	 * @param result
	 * @return lancamento
	...
	/**
	 * Converter uma entidade lançamento em seu respectivo DTO.
	 * 
	 * @param lancamento
	 * @retur LancamentoDto
	 */
